imporwsl python3 create_dashboard.py
      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            A list of all companies including their name, domain, and affiliate URL.
          </p>
        </div>
      </div>
...
with open("app/components/admin/Dashboard.tsx", "w", encoding="utf-8") as f:
    f.write(content)
